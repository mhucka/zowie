...
pyinstaller: | dependencies dist/$(name).zip

dependencies:;
	pip3 install -r requirements.txt

dist/$(name).zip: set-vars
	$(eval comments_file  := $(shell mktemp /tmp/comments-$(name).XXXXXX))
	pyinstaller --clean pyinstaller-$(platform).spec
	cat <<- EOF > $(comments_file)
	┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
	┃ This Zip archive file includes a self-contained, executable ┃
	┃ copy of the program Zowie ("ZOtero link WrItEr") for macOS  ┃
	┃ systems. To learn more about Zowie, please visit this site: ┃
	┃                                                             ┃
...
pyz: | set-vars dependencies dist/$(name)-${version}-${platform}-python3.8.zip

dist/$(name)-${version}-${platform}-python3.8.zip: set-vars
...
release-on-github: | set-vars update-init-file update-codemeta-file check-in-updated-files
